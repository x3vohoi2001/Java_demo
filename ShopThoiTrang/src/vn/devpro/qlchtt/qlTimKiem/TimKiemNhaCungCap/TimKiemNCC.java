package vn.devpro.qlchtt.qlTimKiem.TimKiemNhaCungCap;

import java.util.Scanner;

import vn.devpro.qlchtt.qlCapNhat.cnNhaCungCap.NhaCungCap;
...
public class TimKiemNCC {
	...
	private static void timKiemID() {
		...
		int index = QuanLyNhaCungCap.indexOfID(id);
		if(index == -1) {
			System.out.println("\tKhong co Nha Cung Cap nay!");
			return;
		}
	...
	private static void timKiemTen() {
		...
		int dem =0;
		for(NhaCungCap x : QuanLyNhaCungCap.getList()) {
